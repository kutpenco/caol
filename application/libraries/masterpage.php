...
class Masterpage {
	...
	private function _config() {
		...
		$this->page_title     = $this->CI->config->item('page_title', 'master_page');
	...
	function view($view, $vars = array(), $return = FALSE) {
		...
		if ($this->page_title && !isset($this->header_vars['page_title'])) {
			$this->header_vars['page_title'] = $this->page_title;
		}
