...
class MY_Model extends CI_Model {
	...
	/**
	 * By default fields values are not trimmed. You can trim them, seeting up
	 * this variable to TRUE.
	 */
	protected $fields_trimmed = false;
	...
	public function get_by() {
		...
		$row = $this->trim_fields_values($row);
	...
	/**
	 * Trim spaces for every fields values for current row.
	 */
	public function trim_fields_values($row) {

		if ($this->fields_trimmed) {
